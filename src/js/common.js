...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (headerDropdowns) {
    for (let drop of headerDropdowns) {
      ...
      const headerDropdownItems =
        headerDropdownMenu.querySelectorAll(".header-list__item");
  ...
  if (mainSection) {
    ...
    function parallax(noShow) {
      ...
      if (noShow) {
        ...
        man1.style.bottom = value * 0.2 + "px";
        man2.style.bottom = value * 0.3 + "px";
        man3.style.bottom = value * 0.4 + "px";
        man4.style.bottom = value * 0.4 + "px";
        man5.style.bottom = value * 0.3 + "px";
        man6.style.bottom = value * 0.2 + "px";
        lines.style.top = -value * 0.5 + "px";
        lines.style.marginBottom = -value * 0.3 + "px";
  ...
  if (aboutSection) {
    ...
    function avatarsParallax(noShow) {
      ...
      if (noShow) {
        ...
        avatar2.style.left = value * 0.05 + "px";
        avatar3.style.left = value * 0.12 + "px";
        avatar4.style.left = value * 0.2 + "px";
        avatar5.style.left = value * 0.28 + "px";
        avatar6.style.left = value * 0.38 + "px";
      }
    }
  ...
  const fractionsBottomSlides = document.querySelectorAll(
    ".fractions-swiperBottom .swiper-slide"
  );
  const fractionsTopSlides = document.querySelectorAll(
    ".fractions-swiperTop .swiper-slide"
  );
  ...
  if (fractions) {
    ...
    window.addEventListener("scroll", function () {
      ...
      if (
        offset.top < 0 &&
        offset.bottom - window.innerHeight > 0 &&
        windowWidth > 767
      ) {
        let perc = Math.round(
          (100 * Math.abs(offset.top)) / (offset.height - window.innerHeight)
        );
        if (perc > 10 && perc < 30) {
  ...
  if (teamSection) {
    ...
    const teamPreviewSlides = document.querySelectorAll(
      ".teamPreviewSlider .swiper-slide"
    );
  ...
  if (manifestoSection) {
    ...
    function imageAnimated(noShow) {
      ...
      let perc = Math.round(
        (100 * Math.abs(parent.top)) / (parent.height - window.innerHeight)
      );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (modalSection) {
    ...
    if (choose) {
      const swapBottomInfoButton = choose.querySelector(
        ".choose-bottom__select"
      );
    ...
    if (modalSelectToken) {
      ...
      const manageButtonOpen = modalSelectToken.querySelector(
        ".selectTocken-manage"
      );
      const manageButtonCloseBack =
        modalSelectToken.querySelector(".manage-back");
      const manageButtonClose = modalSelectToken.querySelector(
        ".manage .modal-close"
      );
      const manageTabs = modalSelectToken.querySelectorAll(".manage-tab");
      const manageContents =
        modalSelectToken.querySelectorAll(".manage-content");
    ...
    const connectWalletButton = modalSection.querySelector(
      ".connectWalletButton"
    );
